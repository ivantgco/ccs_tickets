                ...
                if(financing_id != ''){
                    ...
                    socketQuery(o, function(res){
                        ...
                        if(!res.code){
                            ...
                            var form_name = (work_statuses.indexOf(financing_data.status_sysname) == -1 )? (financing_data.closing_financing_id != '')? 'form_merchant_refinancing' : 'form_merchant_financing' : 'form_merchant_financing_work';
