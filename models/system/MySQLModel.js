    ...
    async.waterfall([
        ...
        function (cb) {
            ...
            for (var i in obj) {
                ...
                var colValue = obj[i];
                if ((colProfile.is_virtual && !colProfile.from_table && fromClient) || (!colProfile.server_editable && !colProfile.server_updatable && fromClient && colProfile.column_name !== 'id')) delete obj[i];
            }
            delete obj['created'];
